...
- Always use UTF-8 english language in ui and ux 
- Always respecting right spelling
- At the end of each task, always review the result for inconsistencies introduced by the changes.
